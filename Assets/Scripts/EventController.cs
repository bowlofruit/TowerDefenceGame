...
public class EventController : MonoBehaviour
{
    ...
    public static UnityEvent<float> OnEnemyHealthScaling { get; set; } = new UnityEvent<float>();
    ...
    public static UnityEvent<TowerController, bool> OnUpdateButtonsUI { get; set; } = new UnityEvent<TowerController, bool>();
